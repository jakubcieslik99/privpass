...
const HomeScreen: React.FC = () => {
  return (
    <main>
      <div className="h-screen pt-16 md:pt-24 app-hero-screen">
        <div className="grid h-full grid-flow-col grid-rows-6 app-container md:grid-flow-row md:grid-cols-12 md:grid-rows-1">
          <div className="flex items-center justify-center row-span-2 md:col-span-5">
            <div className="flex flex-col items-center text-white">
              ...
              <button className="px-4 py-3 transition border rounded-full md:text-xl border-percpass-200 text-percpass-200 hover:border-percpass-100 hover:text-percpass-100 active:scale-95 text-md">
                DOWIEDZ SIĘ WIĘCEJ
              </button>
            </div>
          </div>
